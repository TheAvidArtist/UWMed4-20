...
def cleanUp(cutoff,timeRectifyingParams,filePaths,columns):
    ...
    for idx,x in enumerate(filePaths):
        ...
        txt=txt.replace('.txt','')
            ...
            # This for loop was introduced to remove the 2165/165/165 165:165:85
            # string issue. This could be resolved another way to make more 
            # efficent 
            
        for i in range(0,len(df['Date_Time'])):   
            if(df['Date_Time'][i] == '2165/165/165 165:165:85'):
